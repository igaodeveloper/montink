...
import { Truck, Shield, RotateCcw, Clock, ChevronRight, Star, HelpCircle, BadgeCheck, ShoppingCart, Share2, Facebook, Twitter, Instagram } from "lucide-react";
      ...
      >
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            >
              ...
              <a href="#reviews" className="flex items-center justify-center gap-1 rounded-lg border p-3 text-xs text-primary hover:bg-primary/5 transition-colors">
        ...
        >
          ...
          <div className="rounded-xl border bg-card/80 p-6 shadow-sm backdrop-blur-sm">
            <div className="prose max-w-none dark:prose-invert">
              <p>
                A Camiseta Personalizada da Montink é perfeita para você expressar sua individualidade ou promover sua marca. 
                Fabricada com materiais de alta qualidade, oferece conforto excepcional e durabilidade para uso diário.
              </p>
              <p className="mt-4">
                Nossas camisetas são produzidas sob demanda com tecnologia de impressão digital de última geração, 
                garantindo cores vibrantes e detalhes nítidos que não desbotam com o tempo.
              </p>
              ...
              <p>
                Utilizamos a tecnologia DTG (Direct-to-Garment) que permite a impressão diretamente no tecido, 
                garantindo maior qualidade, durabilidade e conforto. Nossas tintas são à base d'água, 
              ...
              <p>
                Para preservar a qualidade da estampa, recomendamos lavar ao avesso, com água fria e 
                sabão neutro. Não usar alvejante ou secadora. Passar ao avesso e evitar o contato do ferro com a estampa.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="mx-auto mt-2 max-w-xl text-muted-foreground">
            Adicione ao carrinho agora mesmo e aproveite o frete grátis para compras acima de R$ 299,90.
          </p>
