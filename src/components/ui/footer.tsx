    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          name: "Moletons",
          href: "#moletons",
          icon: <Icons.hoodie className="h-4 w-4" />,
        },
        {
          name: "Canecas",
          href: "#canecas",
  ...
  return (
    <footer className="bg-gradient-to-b from-background to-secondary/30 pt-12">
      <div className="container">
        ...
        >
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="max-w-md text-center md:text-left">
              ...
              >
                Cadastre-se para receber dicas, tutoriais e novidades sobre como
        ...
        <div className="grid grid-cols-1 gap-8 py-6 md:grid-cols-2 lg:grid-cols-5">
          ...
          >
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Somos uma plataforma de Print On Demand, onde pessoas ou empresas
              conseguem ter seus produtos personalizados com suas estampas,
              vender e lucrar muito, sem precisar investir em estoque, produção
              ou logística.
            </p>
            ...
            <div className="mt-6 space-y-2">
              ...
              >
                ...
                <a
                  href="mailto:contato@montink.com.br"
                  className="hover:text-primary transition-colors"
                >
        ...
        >
          <p>
            © {year} Montink LTDA. CNPJ: 22.733.912/0001-05. Todos os direitos
            reservados.
          </p>
